...
import com.dododial.phone.data.default_database.CallDetail
import com.dododial.phone.data.default_database.CallHistoryFooter
import com.dododial.phone.data.default_database.CallHistoryHeader
import com.dododial.phone.data.default_database.CallLogItem
...
class CallHistoryAdapter (
...
) : ListAdapter<CallLogItem, RecyclerView.ViewHolder>(CombinedComparator()) {
    ...
    class CombinedComparator : DiffUtil.ItemCallback<CallLogItem>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is CallHistoryViewHolder -> {
                ...
                holder.duration.text = current.callDuration + " seconds"
