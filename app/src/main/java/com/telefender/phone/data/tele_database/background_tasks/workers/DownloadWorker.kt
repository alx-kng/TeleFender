...
object DownloadScheduler {
    ...
    suspend fun initiateOneTimeDownloadWorker(context : Context) : UUID {
    ...
    suspend fun initiatePeriodicDownloadWorker(context : Context) : UUID {
        ExperimentalWorkStates.generalizedSetState(
    ...
    override suspend fun doWork() : Result {
        ...
        when (stateVarString) {
            ...
            "periodicDownloadState" -> {
                 ...
                 */
                ExperimentalWorkStates.generalizedSetState(WorkType.PERIODIC_DOWNLOAD, WorkInfo.State.RUNNING)
            }
            else -> {
        ...
        when (stateVarString) {
            "oneTimeDownloadState" -> ExperimentalWorkStates.generalizedSetState(WorkType.ONE_TIME_DOWNLOAD, null)
            "periodicDownloadState" -> ExperimentalWorkStates.generalizedSetState(WorkType.PERIODIC_DOWNLOAD, null)
            else -> {
                Timber.i("$DBL: DOWNLOAD WORKER THREAD: Worker state variable name is wrong")
            }
        }
